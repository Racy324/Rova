    ...
    def load_all(self) -> list[RunTrace]:
        ...
        for line_number, line in enumerate(raw.splitlines(), start=1):
            ...
            if (
                ...
                or record.get("schema_version") not in {1, SCHEMA_VERSION}
            ):
