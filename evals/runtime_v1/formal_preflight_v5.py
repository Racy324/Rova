"""Clean-HEAD preflight for the repaired Runtime V1 Evaluation v5 contract."""
...
from .freeze_v5 import FORMAL_EXECUTION_CONTRACT, SUITE_VERSION, authority_hashes
...
def preflight_formal_suite(
    ...
    *,
    ...
    if actual != manifest.get("authority_file_sha256"):
